...
;!function(){
  ...
  //字符常量
  ,MOD_NAME = 'laydate', ELEM = '.layui-laydate', THIS = 'layui-this', SHOW = 'layui-show', HIDE = 'layui-hide', DISABLED = 'laydate-disabled', TIPS_OUT = 'from date is newer than to<br>suggest to choose again', LIMIT_YEAR = [100, 200000]
