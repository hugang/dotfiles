    ...
    ,views = {
      ...
      ,page: function(){
        ...
        if(index > 1 && config.first !== false && groups !== 0){
          pager.push('<a href="javascript:;" class="layui-laypage-first" data-page="1"  title="最初">'+ (config.first || 1) +'</a>');
        }
        ...
        if(config.pages > groups && config.pages > end && config.last !== false){
          ...
          if(groups !== 0){
            pager.push('<a href="javascript:;" class="layui-laypage-last" title="最後"  data-page="'+ config.pages +'">'+ (config.last || config.pages) +'</a>');
          }
        }
      ...
      //跳页区域
      ,skip: function(){
        return ['<span class="layui-laypage-skip">から'
