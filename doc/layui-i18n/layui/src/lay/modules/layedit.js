...
layui.define(['layer', 'form'], function(exports){
    ...
    body.on('keydown', function(e){
      ...
      if(keycode === 13){
        ...
        if(parentNode.tagName.toLowerCase() === 'pre'){
          ...
          layer.msg('shift+enterをしばらくご利用ください');
          return false;
        }
  ...
  ,link = function(options, callback){
    var body = this, index = layer.open({
      ...
      ,content: ['<ul class="layui-form" style="margin: 15px;">'
        ...
        ,'</li>'
        ,'<li class="layui-form-item">'
          ,'<label class="layui-form-label" style="width: 60px;">開く</label>'
          ,'<div class="layui-input-block" style="margin-left: 90px">'
            ,'<input type="radio" name="target" value="_self" class="layui-input" title="カレントウィンドウ"'
            + ((options.target==='_self' || !options.target) ? 'checked' : '') +'>'
            ,'<input type="radio" name="target" value="_blank" class="layui-input" title="新しいウィンドウ" '
  ...
  ,code = function(callback){
    var body = this, index = layer.open({
      ...
      ,content: ['<ul class="layui-form layui-form-pane" style="margin: 15px;">'
        ,'<li class="layui-form-item">'
          ,'<label class="layui-form-label">言語選択</label>'
        ...
        ,'<li class="layui-form-item layui-form-text">'
          ,'<label class="layui-form-label">コード</label>'
          ,'<div class="layui-input-block">'
  ...
  //全部工具
  ,tools = {
    html: '<i class="layui-icon layedit-tool-html" title="ソース" lay-command="html" layedit-event="html"">&#xe64b;</i><span class="layedit-tool-mid"></span>'
    ,strong: '<i class="layui-icon layedit-tool-b" title="ボルド" lay-command="Bold" layedit-event="b"">&#xe62b;</i>'
    ,italic: '<i class="layui-icon layedit-tool-i" title="イタリック" lay-command="italic" layedit-event="i"">&#xe644;</i>'
    ,underline: '<i class="layui-icon layedit-tool-u" title="アンダーライン" lay-command="underline" layedit-event="u"">&#xe646;</i>'
    ,del: '<i class="layui-icon layedit-tool-d" title="取り消し線" lay-command="strikeThrough" layedit-event="d"">&#xe64f;</i>'
    
    ,'|': '<span class="layedit-tool-mid"></span>'
    
    ,left: '<i class="layui-icon layedit-tool-left" title="左寄せ" lay-command="justifyLeft" layedit-event="left"">&#xe649;</i>'
    ,center: '<i class="layui-icon layedit-tool-center" title="中央寄せ" lay-command="justifyCenter" layedit-event="center"">&#xe647;</i>'
    ,right: '<i class="layui-icon layedit-tool-right" title="右寄せ" lay-command="justifyRight" layedit-event="right"">&#xe648;</i>'
    ,link: '<i class="layui-icon layedit-tool-link" title="リンク追加" layedit-event="link"">&#xe64c;</i>'
    ,unlink: '<i class="layui-icon layedit-tool-unlink layui-disabled" title="リンク削除" lay-command="unlink" layedit-event="unlink"">&#xe64d;</i>'
    ,face: '<i class="layui-icon layedit-tool-face" title="絵文字" layedit-event="face"">&#xe650;</i>'
    ,image: '<i class="layui-icon layedit-tool-image" title="画像" layedit-event="image">&#xe64a;<input type="file" name="file"></i>'
    ,code: '<i class="layui-icon layedit-tool-code" title="コード挿入" layedit-event="code">&#xe64e;</i>'
    
    ,help: '<i class="layui-icon layedit-tool-help" title="ヘルプ" layedit-event="help">&#xe607;</i>'
  }
