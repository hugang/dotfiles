...
layui.define(['laytpl', 'form'], function(exports){
  ...
  ,TPL_BOX = function(obj){
    ...
    return ['<div class="layui-transfer-box" data-index="'+ obj.index +'">'
      ...
      ,'<div class="layui-transfer-search">'
        ...
        ,'<input type="input" class="layui-input" placeholder="${transfer_keyword_search}">'
      ,'</div>'
      ,'{{# } }}'
  ...
  Class.prototype.config = {
    title: ['${transfer_title1}', '${transfer_title2}']
    ,width: 200
    ,height: 360
    ,data: [] //数据源
    ,value: [] //选中的数据
    ...
    ,id: '' //唯一索引，默认自增 index
    ,text: {
      none: '${transfer_nodata}'
      ,searchNone: '${transfer_search_nodata}'
    }
  };
