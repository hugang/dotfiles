...
layui.define('form', function(exports){
  ...
  Class.prototype.config = {
    ...
    ,text: {
      defaultNodeName: '${tree_no_name}' //节点默认名称
      ,none: '${tree_no_data}'  //数据为空时的文本提示
    }
  };
  ...
  Class.prototype.operate = function(elem, item){
    ...
    entry.children('.layui-tree-btnGroup').on('click', '.layui-icon', function(e){
      ...
      //删除
        ...
        layer.confirm('${tree_del_confirm_msg} "<span style="color: #999;">'+ (item.title || '') +'</span>" ${tree_del_confirm_question}', function(index){
